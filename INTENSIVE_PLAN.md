...
- Минимально настроить и запустить, проверить, чтоб работало
  - Кастомизировать будем ужее далее, сначала просто ЗАПУСТИТЬ, чтобы коннектилось с игрой и т.д.
  - LLM уже можно запустить, бесплатный Mistral LLM API работающий без *сервисов смены интернет-региона* описан в пункте 4.3
...
2.3.3 Кастомизация кода в Python-скрипте (см. [тут](https://3ndetz.github.io/NetTyan/CUSTOMIZATION/) или docs/customization.md в python-репозитории)

  Можно внедрить 3.1.3, 3.2, 4.2
