...
| ID | Роли | ID pre | Важность | Описание |
|-----|-----|-----|---|---|
| Prep | ВСЕ | ID необходимых предыдущих задач | Обязательно | Преподготовка |
...
| ID    | Роли | ID pre | Важность | Описание         |
|-------|------|----|-------------|------------------|
| 1.1   | Хост | Prep | Обязательно | Выбрать трек     |
...
| ID | Роли | ID pre | Важность | Описание |
|-----|-----|----|---|---|
| 1.2.2 | Хост, ТРЕКИ выше Standart - Rich/Ultra/Maximus | 1.2.1 | Обязательно |  |
...
| ID | Роли | ID pre | Важность | Описание |
|-----|-----|----|---|---|
| 1.3 | Хост | 1.2.1 | Обязательно | Устанавливаем программы |

### 1.3.1

| ID | Роли | ID pre | Важность | Описание |
|-----|-----|----|---|---|
| 1.3.1 | Хост | 1.3 | Обязательно |  |
...
| ID | Роли | ID pre | Важность | Описание |
|-----|-----|----|---|---|
| 1.3.1 | Хост, треки ВЫШЕ Standart | 1.2.2, 1.3 | Обязательно |  |
...
| ID | Роли | ID pre | Важность | Описание           |
|----|------|----|-------------|--------------------|
| 2  | Хост | 1.3.1 | Обязательно | Техническая сторона запуска ИИ-персонажа |
...
| ID | Роли | ID pre | Важность | Описание           |
|----|------|----|-------------|--------------------|
| 2.1  | Хост | 2 | Обязательно | Программы |
...
| ID | Роли | ID pre | Важность | Описание           |
|----|------|----|-------------|--------------------|
| 2.2  | Хост | 2.1 | Обязательно | Главный Python-скрипт |
...
| ID | Роли | ID pre | Важность | Описание           |
|----|------|----|-------------|--------------------|
| 2.3  | Хост | 2.2 | По желанию | Утончённая настройка под персонажа |
...
| ID | Роли | ID pre | Важность | Описание           |
|----|------|----|-------------|--------------------|
| 2.4  | Хост | 2.3 | Обязательно | Запускаем персонажа в игру - обязательно. Запускать стрим - необязательно, но круто! |
