...
Вам нужен Minecraft 1.21 Java Edition

Скачайте и установите майнкрафт любым удобным способом.

Как вариант, можно можете поставить Freesm - OpenSource лаунчер, доступный с территории России - [Freesm](https://github.com/FreesmTeam/FreesmLauncher)
...
> Внимание! ВЫ СТАВИТЕ МОДЫ, а не ресурспаки, моды в папку **mods**, не resoursepacks!
...
| ID | Роли | Время | Важность | Описание |
|-----|-----|-----|---|---|
| MC-Autoclef | Хост |  | Обязательно | Ставить только ХОСТАМ, это агентный мод |
...
Для удобства я с любовью всё скачал и подготовил модпак, который доступен по [ссылке](https://drive.google.com/drive/folders/1vCPla7RLFf6ZChm0Gp37Czy9fI9jk3KV?usp=sharing). Скачайте и распакуйте архив в какую-нибудь папку, вам нужны `.jar`-файлы в нём.

ИЛИ (в идеале) нужно пройтись по ссылкам актуальных версий модов ниже и скачать `.jar` файл каждого мода

Все моды `.jar` нужно кинуть в папку `mods`. Если автоматически не указалось, нужно выбрать Fabric 1.21 при скачивании.

С доступом к ModRinth (на него ведут ссылки) с территории РФ могут быть проблемы, если они есть, можете запустить под прокси или использовать CurseForge или диск (ссылку выше).
...
> Поздравляю! Теперь ты базово освоился и вспомнил культовую игру детства!

## Дополнительно

### Конфиг-файлы AutoClef
